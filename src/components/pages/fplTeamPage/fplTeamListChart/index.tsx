...
const substitutesContainerSx = (theme) => ({
  display: 'flex',
  alignItems: 'start',
...
const penaltyBoxBottomSx = (theme) => ({
  position: 'absolute',
...
const goalkeeperBoxBottomSx = (theme) => ({
  position: 'absolute',
  transform: `translate(-50%, 0)`,
  bottom: 0,
...
const goalkeeperBoxTopSx = (theme) => ({
  position: 'absolute',
  transform: `translate(-50%, 0)`,
  top: 0,
  width: theme.spacing(15),
...
const penaltyBoxSemiCircleBottomSx = (theme) => ({
  position: 'absolute',
  transform: `translate(-50%, 0)`,
...
const penaltyBoxSemiCircleTopSx = (theme) => ({
  position: 'absolute',
...
const penaltySpotBottomSx = (theme) => ({
  position: 'absolute',
  transform: `translate(-50%, 0)`,
    ...
    <div data-testid='FplTeamListChart'>
      ...
      <Box sx={chartContainerSx}>
        <Box sx={startingContainerSx}>
          ...
          <Box sx={goalkeeperBoxTopSx}>
          </Box>
          <Box sx={penaltySpotTopSx}>
          </Box>
          <Box sx={penaltyBoxTopSx}>
          </Box>
          <Box sx={penaltyBoxSemiCircleTopSx}>
          </Box>

          <Box sx={centerSpotSx}>
          </Box>
          <Box sx={centerCircleSx}>
          </Box>
          <Box sx={halfWayLineSx}>
          </Box>

          <Box sx={penaltyBoxSemiCircleBottomSx}>
          </Box>
          <Box sx={penaltyBoxBottomSx}>
          </Box>
          <Box sx={penaltySpotBottomSx}>
          </Box>
          <Box sx={goalkeeperBoxBottomSx}>
          </Box>
        </Box>
        <Box
          data-testid='substitute'
          sx={substitutesContainerSx}
        >
          {
